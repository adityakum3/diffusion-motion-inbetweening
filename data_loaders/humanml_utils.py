...
MAT_POS = np.zeros((22, 263), dtype=np.bool_)
MAT_POS[0, 1:4] = True
...
MAT_ROT = np.zeros((22, 263), dtype=np.bool_)
MAT_ROT[0, 0] = True
for joint_idx in range(1, 22):
